...
public class ProductOrder {
  ...
  public String toString() {
    return "ProductOrder [no=" + no + ", meno=" + meno + ", ptno=" + ptno + ", cnt=" + cnt
        ...
        + parc_name + ", parc_no=" + parc_no + ", mentee=" + mentee + ", product=" + product
        + ", sellernick=" + sellernick + ", stname=" + stname + ", prdt_titl=" + prdt_titl
        + ", mete_nick=" + mete_nick + ", mete2_nick=" + mete2_nick + ", prdt_pric=" + prdt_pric
        + ", mete_name=" + mete_name + ", mete2_name=" + mete2_name + ", mete2_phone=" + mete2_phone
        + "]";
  }
